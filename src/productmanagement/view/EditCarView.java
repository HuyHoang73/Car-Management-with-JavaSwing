...
public class EditCarView extends JDialog {
	...
	private void initialize() {
		...
		frmEditCar.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		...
		comboBoxEditTypeCar = new JComboBox<Object>();
		comboBoxEditTypeCar.setModel(new DefaultComboBoxModel<Object>(new String[] {"Xe xăng", "Xe điện"}));
